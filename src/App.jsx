      ...
      <section className="md:flex bg-white shadow rounded-3xl">
        <div className="bg-div p-8 text-center text-white rounded-b-3xl md:flex-1 md:rounded-3xl md:pt-10 md:flex md:flex-col md:items-center md:justify-center">
          ...
          <div className="flex items-center justify-center">
            <div className="bg-circle w-24 h-24 flex flex-col items-center justify-center gap-1 rounded-full text-white text-3xl font-bold md:w-40 md:h-40 md:text-6xl">
              76
              <p className="text-slate-200 text-base font-normal">of 100</p>
            </div>
          </div>
